...
<head>
    ...
    <link rel="${pageContext.request.contextPath}/css/modules/laydate/default/laydate.css" >
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/style.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/modules/layer/default/layer.css">
    <script src="${pageContext.request.contextPath}/js/laydate.js"></script> <!-- 要在layui 的前边不然时间插件失效 -->
